...
void PostStatement(index) async {
  ...
  dynamic n=SelectedValue[index];
  String m=conditioner[index-1];

  var apiUrl="http://81.68.216.118:9094/api/post/airset/$m";

    var result=await http.post(Uri.parse(apiUrl),body: {"Num":"$n"});
  ...
  // http.Response response=await client.post("http://81.68.216.118:9094/api/post/airset/$m",body: {"$m":$n});
  // HttpClientRequest request = await httpClient
  //     .postUrl(Uri.parse("http://81.68.216.118:9094/api/post/airset/$m"));
  // request.add(utf8.encode("{\"Num\":$n}"));
